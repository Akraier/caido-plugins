// Ported from quickssrf (https://github.com/caido-community/quickssrf) — MIT License,
// Copyright (c) 2026 Caido Labs Inc. interactsh key lifecycle + message decryption. Storage is
// injected (ensureKeysWithStorage) so the RSA keypair is generated once and persisted.
import { Buffer } from "buffer";
import { randomBytes } from "crypto";

import { aesCfbDecrypt, aesCtrDecrypt } from "./aes.js";
import {
  base64ToUint8,
  deserializeKeyPair,
  exportPublicKeyPEM,
