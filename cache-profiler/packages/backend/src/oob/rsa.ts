...
// Copyright (c) 2026 Caido Labs Inc. Pure-TS RSA (BigInt) — keygen, RSA-OAEP decrypt, ASN.1/PEM
// export — because the Caido QuickJS backend crypto module exposes no public-key primitives.
