...
// Copyright (c) 2026 Caido Labs Inc. interactsh OAST provider: register / poll / deregister,
// outbound via caido:http, RSA/AES handled by ./crypto. Imports rewired to this plugin's
// self-contained crypto + types modules.
